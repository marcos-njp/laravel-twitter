    ...
    <div class="row justify-content-center g-5">
        ...
        <div class="col-lg-7">
            ...
            <div class="modern-card p-4 border-0 mb-4 position-relative overflow-hidden" 
                 style="background: linear-gradient(135deg, #d97706 0%, #b45309 100%); color: white;">
                <div class="position-absolute top-0 end-0 opacity-10 translate-middle-y" 
                     style="transform: rotate(15deg); margin-right: -20px;">
                    <x-heroicon-s-book-open style="width: 120px;" />
                </div>
                
                <div class="d-flex align-items-center gap-3 position-relative z-1">
                    <div class="p-3 rounded-circle bg-white bg-opacity-20 shadow-sm">
                        <x-heroicon-s-sparkles style="width: 32px; color: #fff;" />
                    </div>
                    <div>
                        <h4 class="mb-1 fw-bold" style="font-family: 'Merriweather', serif;">Welcome to Birdie.</h4>
                        <p class="mb-0 opacity-90" style="font-size: 0.95rem;">
                            Share your thoughts, track your growth, and connect with the community.
                        </p>
                    </div>
                </div>
            </div>
