...
<body class="d-flex flex-column min-vh-100">
    <div id="app" class="flex-grow-1">
        <nav class="navbar navbar-expand-md sticky-top">
            <div class="container">
                <a class="navbar-brand fw-bold fs-2 d-flex align-items-center gap-2" href="{{ route('tweets.index') }}" style="font-family: 'Merriweather', serif !important; letter-spacing: -1px; color: #1a4d2e;">
    ...
    <footer class="py-5 mt-auto bg-white border-top">
        <div class="container text-center">
            ...
            <h6 class="fw-bold text-dark mb-3" style="font-family: 'Merriweather', serif;">
            ...
            <div class="d-flex justify-content-center gap-4">
                <a href="https://www.linkedin.com/in/ni%C3%B1o-marcos/" target="_blank" class="text-decoration-none text-muted d-flex align-items-center gap-1 fw-bold" style="font-family: 'Inter', sans-serif; font-size: 0.9rem;">
                    <svg style="width: 18px; fill: currentColor;" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                    LinkedIn
                </a>
